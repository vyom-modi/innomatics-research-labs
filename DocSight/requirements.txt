...
- Google API Key: Obtain a Google API key to interact with Google's Generative AI models. Visit [Google API Key Setup](https://aistudio.google.com/app/apikey) to get your key.
